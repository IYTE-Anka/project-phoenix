...
class DetectionModel(paddle.nn.Layer):
    def __init__(self):
        ...
        self.conv2d35 = paddle.nn.Conv2D(stride=2, padding=1, out_channels=128, kernel_size=(3, 3), in_channels=128)
        self.silu35 = paddle.nn.Silu()
        self.conv2d36 = paddle.nn.Conv2D(out_channels=256, kernel_size=(1, 1), in_channels=384)
        self.silu36 = paddle.nn.Silu()
        self.conv2d37 = paddle.nn.Conv2D(padding=1, out_channels=128, kernel_size=(3, 3), in_channels=128)
        ...
        self.conv2d39 = paddle.nn.Conv2D(out_channels=256, kernel_size=(1, 1), in_channels=384)
        self.silu39 = paddle.nn.Silu()
        self.conv2d40 = paddle.nn.Conv2D(stride=2, padding=1, out_channels=256, kernel_size=(3, 3), in_channels=256)
        self.silu40 = paddle.nn.Silu()
        self.conv2d41 = paddle.nn.Conv2D(out_channels=512, kernel_size=(1, 1), in_channels=768)
        self.silu41 = paddle.nn.Silu()
        self.conv2d42 = paddle.nn.Conv2D(padding=1, out_channels=256, kernel_size=(3, 3), in_channels=256)
        self.silu42 = paddle.nn.Silu()
        self.conv2d43 = paddle.nn.Conv2D(padding=1, out_channels=256, kernel_size=(3, 3), in_channels=256)
        self.silu43 = paddle.nn.Silu()
        self.conv2d44 = paddle.nn.Conv2D(out_channels=512, kernel_size=(1, 1), in_channels=768)
        ...
        self.conv2d45 = paddle.nn.Conv2D(padding=1, out_channels=64, kernel_size=(3, 3), in_channels=128)
        ...
        self.conv2d49 = paddle.nn.Conv2D(padding=1, out_channels=128, kernel_size=(3, 3), in_channels=128)
        self.silu48 = paddle.nn.Silu()
        self.conv2d50 = paddle.nn.Conv2D(out_channels=1, kernel_size=(1, 1), in_channels=128)
        self.conv2d51 = paddle.nn.Conv2D(padding=1, out_channels=64, kernel_size=(3, 3), in_channels=256)
        ...
        self.conv2d54 = paddle.nn.Conv2D(padding=1, out_channels=128, kernel_size=(3, 3), in_channels=256)
        self.silu51 = paddle.nn.Silu()
        self.conv2d55 = paddle.nn.Conv2D(padding=1, out_channels=128, kernel_size=(3, 3), in_channels=128)
        self.silu52 = paddle.nn.Silu()
        self.conv2d56 = paddle.nn.Conv2D(out_channels=1, kernel_size=(1, 1), in_channels=128)
        self.conv2d57 = paddle.nn.Conv2D(padding=1, out_channels=64, kernel_size=(3, 3), in_channels=512)
        ...
        self.conv2d60 = paddle.nn.Conv2D(padding=1, out_channels=128, kernel_size=(3, 3), in_channels=512)
        self.silu55 = paddle.nn.Silu()
        self.conv2d61 = paddle.nn.Conv2D(padding=1, out_channels=128, kernel_size=(3, 3), in_channels=128)
        self.silu56 = paddle.nn.Silu()
        self.conv2d62 = paddle.nn.Conv2D(out_channels=1, kernel_size=(1, 1), in_channels=128)
...
def main(x0):
    ...
    params = paddle.load(r'/content/anka_v1.0_paddle_model/model.pdparams')
